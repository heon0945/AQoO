    ...
    return (
        ...
        >
            <div className="relative bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-96 border-t-4 border-blue-500">
                ...
                <h2 className="text-center text-3xl font-bold text-blue-900 mb-6">비밀번호 재설정</h2>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <InputField
                        label="새 비밀번호"
                        type="password"
                        placeholder="새 비밀번호 입력"
                        {...register("newPassword", { required: "새 비밀번호는 필수 입력 항목입니다." })}
                    ...
                    <InputField
                        ...
                        {...register("confirmPassword", { required: "비밀번호 확인은 필수 입력 항목입니다." })}
